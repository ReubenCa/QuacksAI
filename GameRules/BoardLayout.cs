namespace GameRules
{
    ...
    {
        private readonly (int Money, int VP, bool Ruby)[] Board;
        public int GetMoney(int space)
        {
        ...
        public bool GetRuby(int space)
        {
            return Board[space].Ruby;
        }
       readonly (int Money, int VP, bool Ruby)[] DefaultBoard = {(0, 0, false),(1, 0, false),(2, 0, false),(3, 0, false),(4, 0, false),(5, 0, true)
    ...
    //Constructor 
    public BoardLayout((int Money, int VP, bool Ruby)[]? layout = null)
        {
            Board = layout == null ? DefaultBoard : layout;
        }
    }
}